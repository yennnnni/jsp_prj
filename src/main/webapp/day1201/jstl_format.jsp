		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
					...
					<ul>
					<li>0패턴 사용</li>
					<li><fmt:formatNumber value="${ num }" pattern="0,000,000"/></li>
					<li>#패턴 사용</li>
					<li><fmt:formatNumber value="${ num }" pattern="#,###,###"/></li>
					<li>날짜형식</li>
					<li><fmt:formatDate value="${ date }" pattern="yyyy-MM-dd EEEE a HH:mm:ss"/></li>
					</ul>
