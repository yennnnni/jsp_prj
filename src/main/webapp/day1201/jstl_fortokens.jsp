  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				...
				<%
				//1. data
				String csvData="사과,배,딸기,바나나,오렌지,자몽,망고";
				//2. scope객체에 할당
				pageContext.setAttribute("csvData", csvData);
				%>
				<!-- 3. JSTL과 EL을 사용하여 사용자에 출력 -->
				<c:out value="${ csvData }"/>
				<br>
				다음 중 사람이 만든 과일은?<br>
				<c:forTokens var="fruit" items="${ csvData }" delims="," varStatus="i">
				<c:out value="${ i.count }"/>.
				<input type="checkbox" value="${ fruit }"/><c:out value="${ fruit }"/>
				</c:forTokens>
				</div>
