  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
					<input type="button" value="HTML요청" class="btn btn-success" id="btnHTML">
					<input type="button" value="TEXT요청" class="btn btn-warning" id="btnText">
					<input type="button" value="XML요청" class="btn btn-primary" id="btnXML">
					<input type="button" value="JSON요청" class="btn btn-info" id="btnJSON">
					<div id="output"></div>
				</div>
